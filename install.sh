...
echo ""
echo "Done! All 9 Vibe Startup commands installed to $CLAUDE_CMD_DIR"
echo ""
...
echo ""
echo "Also install these companion frameworks separately:"
echo "  /vibe-production  — https://github.com/zivcheung-bit/vibe-coding"
echo "  /vibe-marketing   — https://github.com/zivcheung-bit/vibe-marketing"
